...
function M.detect_project(source)
  ...
  -- - If the immediate parent package is Deno, it is considered a package within that workspace, and root_dir is set to the workspace root.
  -- - If the immediate parent package is non-Deno, it is considered a single non-Deno project located under an unrelated Deno workspace.
